...
- **Adi Ben David**, [Abstraction Addiction](Adi Ben David - Abstraction Addiction.pdf) (PDF)
- **Alex Cohn**, [Const correctly in C++](Alex Cohn - const correctly in C++.pdf) (PDF)
- **Alex Dathskovsky**, [C++23 tools that you will actually use](Alex Dathskovsky - C++23 tools that you will actually use.pdf) (PDF)
- **Alex Kushnir**, [Managing dependencies with CMake](Alex Kushnir - Managing dependencies with CMake.pdf) (PDF)
...
- **Eshcar Hillel**. [Cost efficient llm inference](Eshcar Hillel - Cost efficient llm inference.pdf) (PDF)
...
- **Miri Ben-Nissan**, [C++20/23 features for better code](Miri Ben-Nissan - C++20-23 features for better code.pdf) (PDF)
